ALTER TABLE deploy_jobs ADD COLUMN git_base_sha TEXT NULL;
...
CREATE TABLE deploy_jobs_new (
    ...
    git_ref TEXT,
    git_sha TEXT,
    job_kind TEXT NOT NULL DEFAULT 'standard' CHECK (job_kind IN ('standard', 'pr_preview', 'pr_preview_destroy')),
